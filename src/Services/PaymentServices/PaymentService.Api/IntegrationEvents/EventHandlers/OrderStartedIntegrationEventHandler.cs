	...
	public class OrderStartedIntegrationEventHandler : IIntegrationEventHandler<OrderStartedIntegrationEvent>
	{
		...
		public Task Handle(OrderStartedIntegrationEvent @event)
		{
			...
			IntegrationEvent paymentEvent = paymentSuccessFlag 
				...
				: new OrderPaymentFailedIntegrationEvent(@event.OrderId, @event.ErrorMessage ?? "This is a fake error message");

			logger.LogInformation($"OrderCreatedIndegrationEventHandler in PaymentService is fired with PaymentSuccess: {paymentSuccessFlag}, orderId: {@event.OrderId}");
